    ...
    <footer style={{ background: 'var(--bg2)', borderTop: '1px solid var(--border)', padding: '48px 0 32px' }}>
      ...
      <div className="container">
        <div className="footer-grid">
          <div>
            ...
            <p style={{ color: 'var(--muted)', fontSize: 14, lineHeight: 1.7 }}>
              Freelance developer building student-grade projects with professional quality at affordable prices.
            </p>
          </div>

          <div>
            <div style={{ fontWeight: 600, marginBottom: 16 }}>Domains</div>
            {['AI / ML', 'Web Apps', 'Data Science', 'Mobile Apps'].map(p => (
          ...
          <div>
            ...
            {[{ to: '/hire', label: 'Hire Me' }, { to: '/projects', label: 'All Projects' }].map(l => (
        ...
        <div style={{ borderTop: '1px solid var(--border)', paddingTop: 24, textAlign: 'center', color: 'var(--muted)', fontSize: 13 }}>
          © {new Date().getFullYear()} DevFolio — Quality projects, affordable prices.
        </div>
      </div>
    </footer>
  );
