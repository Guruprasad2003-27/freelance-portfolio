...
const defaultProjects = [
  ...
  { id: 4, title: 'Emotion Detection', category: 'AI/ML', description: 'Real-time emotion detection using deep learning and webcam.', tech: ['Python', 'TensorFlow', 'OpenCV'], features: ['7 emotions', 'Real-time', 'REST API'], price: { basic: 1500, standard: 3000, premium: 4000 }, icon: '😊', color: '#DC2626' },
